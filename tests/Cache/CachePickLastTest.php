...
class CachePickLastTest extends ManagerCommonCases {

    public static $cache;

    public static function setupBeforeClass() {

        $logger = new Logger('CachePickLastTest');

        $logger->pushHandler(new StreamHandler(__DIR__."/../tmp/CachePickLastTest.log", Logger::DEBUG));
