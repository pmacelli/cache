...
class MemcachedCache extends MemcachedProvider {
    ...
    public function __construct( $server, $port=11211, $weight=0, $persistent_id=null, LoggerInterface $logger=null ) {
        ...
        $this->loggger->notice("Use of MemcachedCache is deprecated, please use \Comodojo\Cache\Providers\MemcachedProvider in conjunction with CacheManager instead.");
